...
<div class="mx-auto max-w-xl">
    ...
    <nav class="mb-6 flex items-center gap-2 text-sm text-muted-foreground" aria-label="Nawigacja">
        ...
        <span class="text-foreground font-medium">Nowe drzewo</span>
    </nav>

    <div class="rounded-lg border border-border bg-card shadow-sm">
        <div class="border-b border-border px-6 py-4">
            <h1 class="text-lg font-semibold text-card-foreground">Nowe drzewo genealogiczne</h1>
            <p class="mt-0.5 text-sm text-muted-foreground">
                Nadaj drzewie nazwę i opcjonalnie opis. Możesz je edytować w dowolnym momencie.
            </p>
        </div>

        <form method="POST" action="/trees" class="p-6 space-y-5" novalidate>
            <?= Csrf::hiddenInput() ?>
            ...
            <div class="space-y-1.5">
                ...
                <textarea
                    ...
                    rows="3"
                    maxlength="1000"
                    placeholder="Krótki opis drzewa — np. 'Linia po mieczu, od XVII wieku'"
            ...
            <div class="flex items-start gap-3 rounded-md border border-border bg-muted/40 p-4">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-xs text-muted-foreground">
                        Inni użytkownicy będą mogli znaleźć to drzewo w globalnym widoku.
                        Prywatne dane osób pozostają chronione niezależnie od tej opcji.
                    </p>
                </div>
            </div>
